...
function Avatar({ type, image, setImage }) {
  ...
  // reads the file as image and set the image
    ...
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          ...
          >
            <div
              className={`z-10 bg-photopicker-overlay-background h-60 w-60 absolute top-0 left-0 flex items-center justify-center flex-col text-center gap-2 rounded-full
